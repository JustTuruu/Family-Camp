        ...
        >
          <address className="not-italic space-y-6 mb-12">
            ...
            <div className="flex items-center gap-5">
              <div className="w-12 h-12 rounded-2xl bg-sand/50 flex items-center justify-center flex-shrink-0" aria-hidden="true">
              ...
              <div>
                <p className="text-xs text-bark/50 uppercase tracking-wider mb-1 font-body">Утас</p>
                <a
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <p className="text-xs text-bark/50 uppercase tracking-wider mb-1 font-body">Хаяг</p>
                <a
          ...
          <div className="rounded-2xl overflow-hidden border border-sand shadow-md">
            <iframe
              ...
              title="Эрдэнэтээс Family Camp хүртэлх зам"
            />
          </div>
